...
type Order struct {
	...
	PickupAddressID                         *bson.ObjectID `bson:"pickup_address_id"`
	...
	RewardPointsHistoryEntryID              *bson.ObjectID `bson:"reward_points_history_entry_id"`
	...
	CustomerLanguageID                      bson.ObjectID  `bson:"customer_language_id"`
	AffiliateID                             bson.ObjectID  `bson:"affiliate_id"`
	...
	RedeemedRewardPointsEntryID             *bson.ObjectID `bson:"redeemed_reward_points_entry_id"`
}
