...
type Order struct {
	...
	BillingAddressID                        int                `bson:"billing_address_id"`
	ShippingAddressID                       *int               `bson:"shipping_address_id,omitempty"`
	PickupAddressID                         *int               `bson:"pickup_address_id,omitempty"`
	...
	RewardPointsHistoryEntryID              *int               `bson:"reward_points_history_entry_id,omitempty"`
	...
	CustomerLanguageID                      int                `bson:"customer_language_id"`
	AffiliateID                             int                `bson:"affiliate_id"`
	...
	RedeemedRewardPointsEntryID             *int               `bson:"redeemed_reward_points_entry_id,omitempty"`
