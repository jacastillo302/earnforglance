...
type Customer struct {
	...
	StateProvinceID             int                `bson:"state_province_id"`
	Phone                       string             `bson:"phone"`
	Fax                         string             `bson:"fax"`
	VatNumber                   string             `bson:"vat_number"`
	VatNumberStatusID           int                `bson:"vat_number_status_id"`
	TimeZoneID                  string             `bson:"time_zone_id"`
	CustomCustomerAttributesXML string             `bson:"custom_customer_attributes_xml"`
	CurrencyID                  *int               `bson:"currency_id,omitempty"`
	LanguageID                  *int               `bson:"language_id,omitempty"`
	TaxDisplayTypeID            *int               `bson:"tax_display_type_id,omitempty"`
	...
	BillingAddressID            *int               `bson:"billing_address_id,omitempty"`
