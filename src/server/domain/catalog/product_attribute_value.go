...
type ProductAttributeValue struct {
	...
	ProductAttributeMappingID    int                `bson:"product_attribute_mapping_id"`
	AttributeValueTypeID         int                `bson:"attribute_value_type_id"`
	AssociatedProductID          int                `bson:"associated_product_id"`
	Name                         string             `bson:"name"`
	ColorSquaresRgb              string             `bson:"color_squares_rgb"`
	ImageSquaresPictureID        int                `bson:"image_squares_picture_id"`
