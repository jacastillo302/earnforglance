...
type Product struct {
	...
	ParentGroupedID                              bson.ObjectID `bson:"parent_grouped_product_id"`
	...
	ProductTemplateID                            bson.ObjectID `bson:"product_template_id"`
	...
	OverriddenGiftCardAmount                     *float64      `bson:"overridden_gift_card_amount"`
	...
	SampleDownloadID                             bson.ObjectID `bson:"sample_download_id"`
	...
	DeliveryDateID                               bson.ObjectID `bson:"delivery_date_id"`
	...
	ProductAvailabilityRangeID                   bson.ObjectID `bson:"product_availability_range_id"`
	...
	PreOrderAvailabilityStartDateTimeUtc         *time.Time    `bson:"pre_order_availability_start_date_time_utc"`
	...
	BasepriceUnitID                              bson.ObjectID `bson:"baseprice_unit_id"`
	BasepriceBaseAmount                          float64       `bson:"baseprice_base_amount"`
	BasepriceBaseUnitID                          bson.ObjectID `bson:"baseprice_base_unit_id"`
