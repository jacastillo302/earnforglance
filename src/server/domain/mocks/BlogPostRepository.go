...
func (_m *BlogPostRepository) CreateMany(c context.Context, items []domain.BlogPost) error {
...
func (_m *BlogPostRepository) Delete(c context.Context, ID string) error {
	ret := _m.Called(c, ID)
...
func (_m *BlogPostRepository) Fetch(c context.Context) ([]domain.BlogPost, error) {
	ret := _m.Called(c)
...
func (_m *BlogPostRepository) FetchByID(c context.Context, ID string) (domain.BlogPost, error) {
	ret := _m.Called(c, ID)
...
func (_m *BlogPostRepository) Update(c context.Context, blog_post *domain.BlogPost) error {
	ret := _m.Called(c, blog_post)
