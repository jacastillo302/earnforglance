...
func (_m *CurrencyRepository) CreateMany(c context.Context, acl_record []domain.Currency) error {
...
// Create provides a mock function with given fields: c, currency
func (_m *CurrencyRepository) Create(c context.Context, currency *domain.Currency) error {
	ret := _m.Called(c, currency)
...
func (_m *CurrencyRepository) Delete(c context.Context, ID string) error {
	ret := _m.Called(c, ID)
...
func (_m *CurrencyRepository) Fetch(c context.Context) ([]domain.Currency, error) {
	ret := _m.Called(c)
...
func (_m *CurrencyRepository) FetchByID(c context.Context, ID string) (domain.Currency, error) {
	ret := _m.Called(c, ID)
...
// Update provides a mock function with given fields: c, currency
func (_m *CurrencyRepository) Update(c context.Context, currency *domain.Currency) error {
	ret := _m.Called(c, currency)
