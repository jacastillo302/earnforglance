...
func (_m *CategoryUsecase) CreateMany(c context.Context, acl_record []domain.Category) error {
...
func (_m *CategoryUsecase) Create(c context.Context, category *domain.Category) error {
...
func (_m *CategoryUsecase) Delete(c context.Context, ID string) error {
	ret := _m.Called(c, ID)
...
func (_m *CategoryUsecase) Fetch(c context.Context) ([]domain.Category, error) {
	ret := _m.Called(c)
...
func (_m *CategoryUsecase) FetchByID(c context.Context, ID string) (domain.Category, error) {
	ret := _m.Called(c, ID)
...
func (_m *CategoryUsecase) Update(c context.Context, category *domain.Category) error {
	ret := _m.Called(c, category)
