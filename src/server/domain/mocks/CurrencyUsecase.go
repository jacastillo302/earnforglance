...
func (_m *CurrencyUsecase) CreateMany(c context.Context, acl_record []domain.Currency) error {
...
func (_m *CurrencyUsecase) Create(c context.Context, currency *domain.Currency) error {
...
func (_m *CurrencyUsecase) Delete(c context.Context, ID string) error {
	ret := _m.Called(c, ID)
...
func (_m *CurrencyUsecase) Fetch(c context.Context) ([]domain.Currency, error) {
	ret := _m.Called(c)
...
func (_m *CurrencyUsecase) FetchByID(c context.Context, ID string) (domain.Currency, error) {
	ret := _m.Called(c, ID)
...
func (_m *CurrencyUsecase) Update(c context.Context, currency *domain.Currency) error {
	ret := _m.Called(c, currency)
