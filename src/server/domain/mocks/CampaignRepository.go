...
func (_m *CampaignRepository) CreateMany(c context.Context, acl_record []domain.Campaign) error {
...
func (_m *CampaignRepository) Create(c context.Context, campaign *domain.Campaign) error {
...
func (_m *CampaignRepository) Delete(c context.Context, ID string) error {
	ret := _m.Called(c, ID)
...
func (_m *CampaignRepository) Fetch(c context.Context) ([]domain.Campaign, error) {
	ret := _m.Called(c)
...
func (_m *CampaignRepository) FetchByID(c context.Context, ID string) (domain.Campaign, error) {
	ret := _m.Called(c, ID)
...
func (_m *CampaignRepository) Update(c context.Context, campaign *domain.Campaign) error {
	ret := _m.Called(c, campaign)
