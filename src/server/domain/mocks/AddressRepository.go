...
func (_m *AddressRepository) CreateMany(c context.Context, acl_record []domain.Address) error {
...
func (_m *AddressRepository) Create(c context.Context, product_tag *domain.Address) error {
...
func (_m *AddressRepository) Delete(c context.Context, ID string) error {
	ret := _m.Called(c, ID)
...
func (_m *AddressRepository) Fetch(c context.Context) ([]domain.Address, error) {
	ret := _m.Called(c)
...
func (_m *AddressRepository) FetchByID(c context.Context, ID string) (domain.Address, error) {
	ret := _m.Called(c, ID)
...
func (_m *AddressRepository) Update(c context.Context, product_tag *domain.Address) error {
	ret := _m.Called(c, product_tag)
