...
func (_m *AddressUsecase) CreateMany(c context.Context, acl_record []domain.Address) error {
...
func (_m *AddressUsecase) Create(c context.Context, product_tag *domain.Address) error {
...
func (_m *AddressUsecase) Delete(c context.Context, ID string) error {
	ret := _m.Called(c, ID)
...
func (_m *AddressUsecase) Fetch(c context.Context) ([]domain.Address, error) {
	ret := _m.Called(c)
...
func (_m *AddressUsecase) FetchByID(c context.Context, ID string) (domain.Address, error) {
	ret := _m.Called(c, ID)
...
func (_m *AddressUsecase) Update(c context.Context, product_tag *domain.Address) error {
	ret := _m.Called(c, product_tag)
