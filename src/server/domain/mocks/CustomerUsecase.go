...
func (_m *CustomerUsecase) CreateMany(c context.Context, acl_record []domain.Customer) error {
...
func (_m *CustomerUsecase) Create(c context.Context, customer *domain.Customer) error {
...
func (_m *CustomerUsecase) Delete(c context.Context, ID string) error {
	ret := _m.Called(c, ID)
...
func (_m *CustomerUsecase) Fetch(c context.Context) ([]domain.Customer, error) {
	ret := _m.Called(c)
...
func (_m *CustomerUsecase) FetchByID(c context.Context, ID string) (domain.Customer, error) {
	ret := _m.Called(c, ID)
...
func (_m *CustomerUsecase) Update(c context.Context, customer *domain.Customer) error {
	ret := _m.Called(c, customer)
