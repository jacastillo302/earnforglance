...
func (tc *VendorAttributeValueController) CreateMany(c *gin.Context) {
	...
	err = tc.VendorAttributeValueUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *VendorAttributeValueController) Delete(c *gin.Context) {
	...
	err := tc.VendorAttributeValueUsecase.Delete(c, ID)
	if err != nil {
