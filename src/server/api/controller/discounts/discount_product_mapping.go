...
func (tc *DiscountProductMappingController) CreateMany(c *gin.Context) {
	...
	err = tc.DiscountProductMappingUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *DiscountProductMappingController) Delete(c *gin.Context) {
	...
	err := tc.DiscountProductMappingUsecase.Delete(c, ID)
	if err != nil {
