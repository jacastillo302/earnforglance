...
func (tc *CustomerAddressMappingController) CreateMany(c *gin.Context) {
	...
	err = tc.CustomerAddressMappingUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *CustomerAddressMappingController) Delete(c *gin.Context) {
	...
	err := tc.CustomerAddressMappingUsecase.Delete(c, ID)
	if err != nil {
