...
func (tc *MessageTemplatesSettingsController) CreateMany(c *gin.Context) {
	...
	err = tc.MessageTemplatesSettingsUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *MessageTemplatesSettingsController) Delete(c *gin.Context) {
	...
	err := tc.MessageTemplatesSettingsUsecase.Delete(c, ID)
	if err != nil {
