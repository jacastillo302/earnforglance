...
func (tc *ProductReviewHelpfulnessController) CreateMany(c *gin.Context) {
	...
	err = tc.ProductReviewHelpfulnessUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *ProductReviewHelpfulnessController) Delete(c *gin.Context) {
	...
	err := tc.ProductReviewHelpfulnessUsecase.Delete(c, ID)
	if err != nil {
