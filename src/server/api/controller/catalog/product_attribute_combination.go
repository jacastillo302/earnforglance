...
func (tc *ProductAttributeCombinationController) CreateMany(c *gin.Context) {
	...
	err = tc.ProductAttributeCombinationUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *ProductAttributeCombinationController) Delete(c *gin.Context) {
	...
	err := tc.ProductAttributeCombinationUsecase.Delete(c, ID)
	if err != nil {
