...
func (tc *SpecificationAttributeOptionController) CreateMany(c *gin.Context) {
	...
	err = tc.SpecificationAttributeOptionUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *SpecificationAttributeOptionController) Delete(c *gin.Context) {
	...
	err := tc.SpecificationAttributeOptionUsecase.Delete(c, ID)
	if err != nil {
