...
func (tc *ProductReviewReviewTypeMappingController) CreateMany(c *gin.Context) {
	...
	err = tc.ProductReviewReviewTypeMappingUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *ProductReviewReviewTypeMappingController) Delete(c *gin.Context) {
	...
	err := tc.ProductReviewReviewTypeMappingUsecase.Delete(c, ID)
	if err != nil {
