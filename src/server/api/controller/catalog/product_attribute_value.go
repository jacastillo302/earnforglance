...
func (tc *ProductAttributeValueController) CreateMany(c *gin.Context) {
	...
	err = tc.ProductAttributeValueUsecase.CreateMany(c, task)
	if err != nil {
...
func (tc *ProductAttributeValueController) Delete(c *gin.Context) {
	...
	err := tc.ProductAttributeValueUsecase.Delete(c, ID)
	if err != nil {
