...
func (_m *Collection) UpdateMany(_a0 context.Context, _a1 interface{}, _a2 interface{}, _a3 ...*options.UpdateManyOptions) (*mongo_drivermongo.UpdateResult, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, interface{}, ...*options.UpdateManyOptions) *mongo_drivermongo.UpdateResult); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, interface{}, interface{}, ...*options.UpdateManyOptions) error); ok {
...
func (_m *Collection) UpdateOne(_a0 context.Context, _a1 interface{}, _a2 interface{}, _a3 ...*options.UpdateManyOptions) (*mongo_drivermongo.UpdateResult, error) {
	_va := make([]interface{}, len(_a3))
	for _i := range _a3 {
		_va[_i] = _a3[_i]
	}
