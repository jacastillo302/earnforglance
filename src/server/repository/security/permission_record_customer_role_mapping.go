...
func (ur *permissionrecordcustomerrolemappingRepository) Delete(c context.Context, permissionrecordcustomerrolemapping *domain.PermissionRecordCustomerRoleMapping) error {
	collection := ur.database.Collection(ur.collection)
