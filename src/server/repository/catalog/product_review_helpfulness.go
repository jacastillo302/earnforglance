...
func (ur *productreviewhelpfulnessRepository) Delete(c context.Context, productreviewhelpfulness *domain.ProductReviewHelpfulness) error {
	collection := ur.database.Collection(ur.collection)
...
func (tr *productreviewhelpfulnessRepository) FetchByID(c context.Context, productreviewhelpfulnessID string) (domain.ProductReviewHelpfulness, error) {
	...
	idHex, err := primitive.ObjectIDFromHex(productreviewhelpfulnessID)
	if err != nil {
