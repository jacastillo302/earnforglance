...
func (ur *productproducttagmappingRepository) CreateMany(c context.Context, items []domain.ProductProductTagMapping) error {
...
func (tr *productproducttagmappingRepository) FetchByID(c context.Context, productproducttagmappingID string) (domain.ProductProductTagMapping, error) {
	...
	idHex, err := bson.ObjectIDFromHex(productproducttagmappingID)
	if err != nil {
