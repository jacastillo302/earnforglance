...
func (ur *productattributecombinationRepository) CreateMany(c context.Context, items []domain.ProductAttributeCombination) error {
...
func (tr *productattributecombinationRepository) FetchByID(c context.Context, productattributecombinationID string) (domain.ProductAttributeCombination, error) {
	...
	idHex, err := bson.ObjectIDFromHex(productattributecombinationID)
	if err != nil {
