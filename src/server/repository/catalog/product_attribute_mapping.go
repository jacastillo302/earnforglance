...
func (ur *productattributemappingRepository) Delete(c context.Context, productattributemapping *domain.ProductAttributeMapping) error {
	collection := ur.database.Collection(ur.collection)
...
func (tr *productattributemappingRepository) FetchByID(c context.Context, productattributemappingID string) (domain.ProductAttributeMapping, error) {
	...
	idHex, err := primitive.ObjectIDFromHex(productattributemappingID)
	if err != nil {
