...
func (ur *ProductAttributeCombinationPictureRepository) Delete(c context.Context, ProductAttributeCombinationPicture *domain.ProductAttributeCombinationPicture) error {
	collection := ur.database.Collection(ur.collection)
